...
export default function JobApplicationPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = 'https://final-forms-xduf.vercel.app/'
  }

  const relatedForms = [
    {
      title: "Confidentiality Agreement",
      description: "Complete the confidentiality agreement form",
      url: "https://final-forms-xduf.vercel.app/form1",
      icon: (
    ...
    {
      title: "Arrest/Conviction Report",
      description: "Complete the arrest/conviction certification form",
      url: "https://final-forms-xduf.vercel.app/form",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      title: "Form 4",
      description: "Complete Form 4 requirements",
      url: "https://final-forms-xduf.vercel.app/form4",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      title: "Form 6",
      description: "Complete Form 6 requirements",
      url: "https://final-forms-xduf.vercel.app/form6",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      title: "Form 7",
      description: "Complete Form 7 requirements",
      url: "https://final-forms-xduf.vercel.app/form7",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      title: "Form 8",
      description: "Complete Form 8 requirements",
      url: "https://final-forms-xduf.vercel.app/form8",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      title: "Form 9",
      description: "Complete Form 9 requirements",
      url: "https://final-forms-xduf.vercel.app/form9",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      title: "Final Form",
      description: "Complete the final form requirements",
      url: "https://final-forms-xduf.vercel.app/formlast",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
          ...
          <form onSubmit={handleSubmit} className="p-12 space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                After submitting this application, you'll need to complete all required onboarding forms. Click on any form below to access it.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {relatedForms.map((form, index) => (
                  <a
                    ...
                    className={`inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r ${form.color} text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105 group`}
                  >
                    <span className="mr-2 text-sm">{form.title}</span>
                    <svg
