...
export default function W4FormHeader() {
    ...
    return (
      <form onSubmit={handleSubmit} className="max-w-[1100px] mx-auto p-4 border-2 border-gray-300 text-black text-sm leading-[1.4] font-sans">
        {/* Top Row */}
          ...
          <div className="flex flex-col gap-2 w-full border-l mr-2">
            ...
            <div className="flex gap-4 w-full border-b-2">
              <div className="w-1/3 mb-2">
                ...
                <input
                  ...
                  className="h-10 border ml-2 border-gray-300 bg-blue-100 w-full px-2"
                />
              </div>
              <div className="w-1/3 ml-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-10 border border-gray-300 mr-3 bg-blue-100 w-full px-2"
                />
              </div>
              <div className="w-1/3">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-10 border border-gray-300 bg-blue-100 w-full px-2"
                />
              </div>
            </div>
            ...
            <div className="flex gap-4 w-full">
              ...
              <div className="w-2/3 border-b-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-10 bg-blue-100 mt-4 border-gray-300 ml-2 w-full px-2"
                />
              </div>
            ...
            <div className="border-b-2 mb-2">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="h-10 ml-2 mb-2 bg-blue-100 w-full px-2"
              />
            </div>
            ...
            <div className="space-y-2 mt-4">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="mt-[2px]"
                />
                <span>(a) Use the estimator at www.irs.gov/W4App for the most accurate withholding for this step (and Steps 3–4). If 
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="mt-[2px]"
                />
                <span>(b) Use the Multiple Jobs Worksheet on page 3 and enter the result in Step 4(c) below;</span>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  ...
                  className="mt-[2px]"
                />
                <span>(c) If there are only two jobs total, you may check this box. Do the same on Form W-4 for the other job.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex border-b-2">
          ...
          <div className="ml-30">
            <div className="p-3 text-[16px]">
              ...
              <div className="flex items-center justify-between">
                <div className="text-[16px] flex-1"></div>
                ...
                <div className="">
                  ...
                  <div className="h-16 p-1">
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className="w-full h-full mt-8 focus:outline-none bg-blue-100 text-xs"
                    />
                  </div>
                </div>
                <div>
        ...
        <div className="mt-6 flex justify-center">
          <button
            type="submit"
            className="bg-black text-xl font-semibold text-white px-60 py-4 rounded hover:bg-blue-600 transition-colors"
          >
            Submit Form
          </button>
        </div>
